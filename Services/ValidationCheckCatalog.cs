...
internal static class ValidationCheckCatalog
{
    ...
    [
        ...
        new("different_odd_even", "different_odd_even", "DB", "header_footer.different_odd_even", false, false, "Status header/footer ganjil-genap diperiksa dari aturan header_footer.", "header_footer"),
        ...
        new("page_numbering", "page_number_format", "DB (legacy)", "page_numbering.section.*.format", false, false, "Format nomor halaman legacy diperiksa hanya jika aturan page_numbering lama masih ada.", "page_numbering"),
        new("page_numbering", "page_number_start", "DB (legacy)", "page_numbering.section.*.start", false, false, "Nomor awal halaman legacy diperiksa hanya jika aturan page_numbering lama masih ada.", "page_numbering"),
        ...
        new("judul_bab", "judul_bab", "DB + logika kode", "judul_bab.struktur_konten.jumlah_baris_kosong_setelah", false, false, "Jumlah paragraf kosong setelah judul bab diperiksa sesuai nilai di DB.", "judul_bab"),
        ...
        new("judul_bab", "judul_bab", "DB + logika kode", "judul_bab.struktur_konten.minimal_paragraf_sebelum_subbab", false, false, "Minimal jumlah paragraf sebelum subbab pertama diperiksa sesuai nilai di DB.", "judul_bab"),
        ...
        new("judul_subbab", "judul_subbab", "DB + logika kode", "judul_subbab.struktur_konten.minimal_paragraf_setelah", false, false, "Minimal jumlah paragraf setelah judul subbab diperiksa sesuai nilai di DB.", "judul_subbab"),
        ...
        new("judul_subbab", "judul_subbab", "DB + logika kode", "judul_subbab.struktur_konten.minimal_subbab_level_sama", false, false, "Minimal jumlah subbab pada level yang sama diperiksa sesuai nilai di DB.", "judul_subbab"),
        ...
        new("paragraf", "paragraf", "DB + logika kode", "paragraf.paragraph.left_indent", false, false, "Left indent paragraf diperiksa dari DB; setelah list bisa dioverride dari item daftar terakhir.", "paragraf", "item_daftar"),
        ...
        new("paragraf", "paragraf", "DB", "paragraf.paragraph.right_indent", false, false, "Right indent paragraf diperiksa dari DB.", "paragraf"),
        ...
        new("paragraf", "paragraf", "DB + logika kode", "paragraf.struktur_konten.minimal_kalimat", false, false, "Jumlah kalimat minimal per paragraf diperiksa sesuai nilai di DB sebagai saran/non-required.", "paragraf"),
        ...
        new("item_daftar", "item_daftar", "DB", "item_daftar.paragraph.indentation.first_line_indent", false, false, "First line indent item daftar diperiksa dari DB.", "item_daftar"),
        new("item_daftar", "item_daftar", "DB", "item_daftar.paragraph.indentation.right_indent", false, false, "Right indent item daftar diperiksa dari DB.", "item_daftar"),
        ...
        new("gambar", "gambar", "DB", "gambar.paragraph.indentation.left_indent + right_indent + first_line_indent", false, false, "Indentasi paragraf gambar diperiksa dari komponen left/right/first line.", "gambar"),
        ...
        new("caption_gambar", "caption_gambar", "DB", "caption_gambar.paragraph.alignment + indentation.left_indent/right_indent/first_line_indent + spacing", false, false, "Format paragraf caption gambar diperiksa, termasuk indentasi eksplisit.", "gambar", "caption_gambar"),
        ...
        new("caption_tabel", "caption_tabel", "DB", "caption_tabel.paragraph.alignment + indentation.left_indent/right_indent/first_line_indent + spacing", false, false, "Format paragraf caption tabel diperiksa, termasuk indentasi eksplisit.", "tabel", "caption_tabel"),
        ...
        new("kode", "kode", "DB", "kode.paragraph.alignment + indentation + spacing", false, false, "Format paragraf kode diperiksa, termasuk right indent dari DB.", "kode"),
        ...
        new("judul_kode", "judul_kode", "DB", "judul_kode.paragraph.alignment + indentation.left_indent/right_indent/first_line_indent + spacing", false, false, "Format paragraf judul kode diperiksa, termasuk indentasi eksplisit.", "kode", "judul_kode"),
        ...
        new("rumus", "rumus", "DB", "rumus.paragraph.alignment (+ position.paragraph_alignment/equation_alignment jika tersedia)", false, false, "Alignment paragraf rumus diperiksa; override position.* hanya dipakai bila field tersebut ada.", "rumus"),
        ...
        new("rumus", "rumus", "DB + logika kode", "rumus.tabs.left_tab + tabs.right_tab", false, false, "Tab stop kiri/kanan diperiksa: keberadaan, alignment, leader, posisi/jarak minimum, dan depends_on_equation_length.", "rumus"),
        new("rumus", "rumus", "DB + logika kode", "rumus.numbering.number_format", false, false, "Nomor rumus harus ada dan sesuai format.", "rumus"),
        new("rumus", "rumus", "DB + logika kode", "rumus.position.cegah_memenuhi_halaman + rumus.struktur_halaman.minimal_satu_paragraf_di_halaman", false, false, "Halaman rumus tidak boleh hanya berisi rumus bila rule struktur_halaman/position aktif.", "rumus"),
